...
## 🌟 Новое: Интеграция плагинов с Web Dashboard

**✅ Реализовано:**
- 💰 **Начисление монет за убийство монстров** (Combat → Economy)
- 🌐 **Web API для просмотра монет игроков**
- 🛒 **Управление Shop через Web Dashboard** (настройка товаров, цены, иконки)
- 💤 **Управление AFK системой через Web Dashboard Panel**

**📖 Документация:**
- [QUICK_START_INTEGRATION.md](QUICK_START_INTEGRATION.md) - Быстрый старт
- [IMPLEMENTATION_SUMMARY.md](IMPLEMENTATION_SUMMARY.md) - Краткое резюме
- [INTEGRATION_GUIDE.md](INTEGRATION_GUIDE.md) - Полное руководство
- [API_USAGE_EXAMPLES.md](API_USAGE_EXAMPLES.md) - Примеры кода
...
# Откройте API_DEMO.html в браузере для тестирования
```
