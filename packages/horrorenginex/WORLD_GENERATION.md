...
- **Размер**: 10x10 блоков за этаж
- **Материалы**: Темный дуб (DARK_OAK_LOG)
- **Фичи**:
  - Разбитые окна (случайные отверстия)
  - Паутина (COBWEB) на разных этажах
  - Сундук с сокровищами (в случайном месте)
  - Скатная крыша
