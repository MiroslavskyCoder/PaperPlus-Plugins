...
Подземные тайные лаборатории с оборудованием:

- **Размер**: 15x15x8 блоков
- **Глубина**: 10 блоков под землей
- **Материалы**: Железные блоки, бетон, гладкий камень
- **Фичи**:
  - Варочные стойки в углах
  - Котлы для экспериментов
  - Стол зачарования в центре
  - Книжные полки вокруг
  - Сундуки с "исследовательскими заметками"
  - Красные лампы для освещения
  - Диспенсеры и наблюдатели
  - Секретная комната с незеритовым блоком и сундуком
